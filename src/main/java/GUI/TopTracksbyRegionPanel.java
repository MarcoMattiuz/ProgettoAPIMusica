...
import com.prova.ProgettoAPI.Tracks;
import com.prova.ProgettoAPI.Tracks.Track;
...
public class TopTracksbyRegionPanel extends JPanel{
	...
	public TopTracksbyRegionPanel() {setBackground(Color.DARK_GRAY);
	...
	lblTitlePanel_1.setText("Tracks Ranking By Country");
	...
	txtInsertRegiontHere.setToolTipText("Insert the country here...");
	...
	public void addClassifica() {
		String classifica = "";
		Tracks artists =  ApiRequests.GETCountryTopTracks(txtInsertRegiontHere.getText());
		int i=1;
		
		for (Track iteratore : artists.getTrack()) {
			if(i<=50) {
